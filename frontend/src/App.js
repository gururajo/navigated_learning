...
function App() {
  const [isLoggedIn, setIsLoggedIn] = React.useState(true); // Set to false initially for actual use
            ...
            <div style={containerStyle}>
              ...
              <div style={rowStyle}>
                <div style={colStyleLeft}>
                  <LearnerMap activitiesState={activitiesState} learnerPosState={learnerPosState} />
                </div>
              ...
              <div style={colFullWidthStyle}>
                <LearnerSummary activitiesState={activitiesState} learnerPosState={learnerPosState} />
              </div>
            </div>
          </>
        )}
